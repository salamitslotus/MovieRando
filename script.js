...
const movies = {
  netflix: [
    ...
    {title:"Red Notice",year:2021,genre:"action",provider:"Netflix"},
    {title:"The Adam Project",year:2022,genre:"sci-fi",provider:"Netflix"},
    {title:"Bullet Train",year:2022,genre:"action",provider:"Netflix"},
    {title:"Oxygen",year:2021,genre:"thriller",provider:"Netflix"},
    {title:"Spellheist",year:2020,genre:"comedy",provider:"Netflix"},
    {title:"Dumplin'",year:2018,genre:"comedy",provider:"Netflix"},
    {title:"Tall Girl",year:2019,genre:"romance",provider:"Netflix"},
    {title:"Perfume",year:2022,genre:"drama",provider:"Netflix"},
    {title:"I Came By",year:2022,genre:"thriller",provider:"Netflix"},
    {title:"Look Both Ways",year:2022,genre:"romance",provider:"Netflix"},
    {title:"Conviction",year:2019,genre:"drama",provider:"Netflix"},
    {title:"The Diplomat",year:2023,genre:"action",provider:"Netflix"},
    {title:"One Piece Film Red",year:2022,genre:"animation",provider:"Netflix"}
  ],
  hulu: [
    ...
    {title:"Knives Out",year:2019,genre:"mystery",provider:"Hulu"},
    {title:"The Farewell",year:2019,genre:"drama",provider:"Hulu"},
    {title:"Hereditary",year:2018,genre:"horror",provider:"Hulu"},
    {title:"Uncut Gems",year:2019,genre:"thriller",provider:"Hulu"},
    {title:"Waves",year:2019,genre:"drama",provider:"Hulu"},
    {title:"Ready or Not",year:2019,genre:"thriller",provider:"Hulu"},
    {title:"The Farewell",year:2019,genre:"comedy",provider:"Hulu"},
    {title:"Late Night",year:2019,genre:"comedy",provider:"Hulu"},
    {title:"Minari",year:2020,genre:"drama",provider:"Hulu"},
    {title:"The Lighthouse",year:2019,genre:"thriller",provider:"Hulu"},
    {title:"Veep: Season 1",year:2012,genre:"comedy",provider:"Hulu"},
    {title:"Love, Death & Robots",year:2019,genre:"animation",provider:"Hulu"},
    {title:"The Handmaid's Tale",year:2017,genre:"drama",provider:"Hulu"}
  ],
  hbomax: [
    ...
    {title:"Godzilla vs. Kong",year:2021,genre:"action",provider:"HBO Max"},
    {title:"Aquaman",year:2018,genre:"action",provider:"HBO Max"},
    {title:"The Nun",year:2018,genre:"horror",provider:"HBO Max"},
    {title:"Annabelle",year:2014,genre:"horror",provider:"HBO Max"},
    {title:"Insidious",year:2010,genre:"horror",provider:"HBO Max"},
    {title:"The Ring",year:2002,genre:"horror",provider:"HBO Max"},
    {title:"Se7en",year:1995,genre:"thriller",provider:"HBO Max"},
    {title:"The Sixth Sense",year:1999,genre:"thriller",provider:"HBO Max"},
    {title:"Memento",year:2000,genre:"mystery",provider:"HBO Max"},
    {title:"Oldboy",year:2003,genre:"thriller",provider:"HBO Max"},
    {title:"Pulp Fiction",year:1994,genre:"crime",provider:"HBO Max"},
    {title:"Kill Bill: Vol. 1",year:2003,genre:"action",provider:"HBO Max"},
    {title:"Dune: Part Two",year:2024,genre:"sci-fi",provider:"HBO Max"}
  ],
  disney: [
    ...
    {title:"Hercules",year:1997,genre:"animation",provider:"Disney+"},
    {title:"Mulan",year:1998,genre:"animation",provider:"Disney+"},
    {title:"Tangled",year:2010,genre:"animation",provider:"Disney+"},
    {title:"Rapunzel",year:2010,genre:"fantasy",provider:"Disney+"},
    {title:"Zootopia",year:2016,genre:"animation",provider:"Disney+"},
    {title:"Wreck-It Ralph",year:2012,genre:"animation",provider:"Disney+"},
    {title:"Big Hero 6",year:2014,genre:"animation",provider:"Disney+"},
    {title:"Turning Red",year:2022,genre:"animation",provider:"Disney+"},
    {title:"Encanto 2",year:2024,genre:"animation",provider:"Disney+"},
    {title:"Finding Nemo",year:2003,genre:"animation",provider:"Disney+"},
    {title:"Finding Dory",year:2016,genre:"animation",provider:"Disney+"},
    {title:"Toy Story 2",year:1999,genre:"animation",provider:"Disney+"},
    {title:"Toy Story 3",year:2010,genre:"animation",provider:"Disney+"},
    {title:"Monsters, Inc.",year:2001,genre:"animation",provider:"Disney+"},
    {title:"A Bug's Life",year:1998,genre:"animation",provider:"Disney+"},
    {title:"The Good Dinosaur",year:2015,genre:"animation",provider:"Disney+"},
    {title:"Luca",year:2021,genre:"animation",provider:"Disney+"},
    {title:"Up",year:2009,genre:"animation",provider:"Disney+"},
    {title:"Cars",year:2006,genre:"animation",provider:"Disney+"},
    {title:"Ratatouille",year:2007,genre:"animation",provider:"Disney+"},
    {title:"Brave",year:2012,genre:"adventure",provider:"Disney+"},
    {title:"Captain America: The Winter Soldier",year:2014,genre:"action",provider:"Disney+"},
    {title:"Thor: Ragnarok",year:2017,genre:"action",provider:"Disney+"},
    {title:"Doctor Strange",year:2016,genre:"action",provider:"Disney+"},
    {title:"Spider-Man: Homecoming",year:2017,genre:"action",provider:"Disney+"}
  ]
};
